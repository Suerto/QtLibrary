...
Q_CONSTINIT const QMetaObject Search::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6SearchE_t,
        ...
        // method 'risultatiOttenuti'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<vector<Contenuto*>, std::false_type>,
...
void Search::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->risultatiOttenuti((*reinterpret_cast< std::add_pointer_t<vector<Contenuto*>>>(_a[1]))); break;
        case 1: _t->advancedResearch((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 2: _t->startSearch(); break;
        case 3: _t->mostraFiltro((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Search::*)(vector<Contenuto*> );
            if (_q_method_type _q_method = &Search::risultatiOttenuti; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Search::risultatiOttenuti(vector<Contenuto*> _t1)
{
